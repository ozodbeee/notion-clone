...
export const Sidebar = () => {
	...
	const onCreateDocument = () => {
		if (documents?.length && documents.length >= 3 && plan === 'Free') {
			toast.error('You can only have 3 documents in the free plan')
			return
		}
	...
	return (
		<>
			<div
				className={cn(
					'group/sidebar h-screen bg-secondary overflow-y-auto flex w-60 flex-col z-50  sticky top-0 left-0',
